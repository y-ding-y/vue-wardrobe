        ...
        methods: {
            ...
            computeMD5(file) {
                ...
                fileReader.onload = (e => {
                    ...
                    console.log(e)
                    // fileReader.readAsArrayBuffer(new Blob([e.target.result],{type: 'model/gltf-binary'}) )
                    this.$localForage.setItem(`smt2db${currentChunk}`, new Blob([e.target.result],{type: 'model/gltf-binary'}))
